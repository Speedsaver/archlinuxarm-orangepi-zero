...
============
```
sudo apt install autoconf bison fdisk flex gawk gcc-arm-none-eabi help2man libarchive-tools libssl-dev libtool libtool-bin make pip python3-dev sudo swig texinfo u-boot-tools
```
Preparing the files
===================
```
